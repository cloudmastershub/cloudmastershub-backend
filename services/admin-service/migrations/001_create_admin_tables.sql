...
CREATE INDEX IF NOT EXISTS idx_content_moderation_priority ON content_moderation_queue(priority);
CREATE INDEX IF NOT EXISTS idx_content_moderation_content ON content_moderation_queue(content_type, content_id);
CREATE INDEX IF NOT EXISTS idx_content_moderation_author ON content_moderation_queue(author_id);
CREATE INDEX IF NOT EXISTS idx_content_moderation_flagged_at ON content_moderation_queue(flagged_at);
...
CREATE INDEX IF NOT EXISTS idx_user_mgmt_target_user ON user_management_actions(target_user_id);
CREATE INDEX IF NOT EXISTS idx_user_mgmt_admin ON user_management_actions(admin_id);
CREATE INDEX IF NOT EXISTS idx_user_mgmt_action ON user_management_actions(action);
CREATE INDEX IF NOT EXISTS idx_user_mgmt_created_at ON user_management_actions(created_at);
CREATE INDEX IF NOT EXISTS idx_user_mgmt_effective_until ON user_management_actions(effective_until);
...
DROP TRIGGER IF EXISTS update_content_moderation_queue_updated_at ON content_moderation_queue;
